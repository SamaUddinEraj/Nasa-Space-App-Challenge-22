...
data = [{'name':'Lahore', "sel": "selected"}, {'name':'Karachi', "sel": ""}, {'name':'Sindh', "sel": ""}, {'name':'Peshwar', "sel": ""}, {'name':'Chennai', "sel": ""}]
# data = [{'name':'Pakistan', "sel": ""}]
months = [{"name":"May", "sel": ""}, {"name":"June", "sel": ""}, {"name":"July", "sel": "selected"}]
cities = [{'name':'Lahore', "sel": "selected"}, {'name':'Karachi', "sel": ""}, {'name':'Sindh', "sel": ""}, {'name':'Peshwar', "sel": ""}, {'name':'Chennai', "sel": ""}, {'name':'New York', "sel": ""}, {'name':'Los Angeles', "sel": ""}, {'name':'London', "sel": ""}, {'name':'Paris', "sel": ""}, {'name':'Sydney', "sel": ""}, {'name':'Beijing', "sel": ""}]
...
def satellite():
    direc = "processed_satellite_images/Lahore_July.png"
    with open(direc, "rb") as image_file:
        image = base64.b64encode(image_file.read())
    image = image.decode('utf-8')
    return render_template('satellite.html', data=data, image_file=image, months=months, text="Lahore in January 2020")

@app.route('/satellite.html', methods=['GET', 'POST'])
def satelliteimages():
    place = request.form.get('place')
    date = request.form.get('date')
    data = [{'name':'Lahore', "sel": ""}, {'name':'Karachi', "sel": ""}, {'name':'Sindh', "sel": ""}, {'name':'Peshwar', "sel": ""}, {'name':'Chennai', "sel": ""}]
...
def get_predicts():
    try:
        ...
        cities = [{'name':'Lahore', "sel": ""}, {'name':'Karachi', "sel": ""}, {'name':'Sindh', "sel": ""}, {'name':'Peshwar', "sel": ""}, {'name':'Chennai', "sel": ""}, {'name':'New York', "sel": ""}, {'name':'Los Angeles', "sel": ""}, {'name':'London', "sel": ""}, {'name':'Paris', "sel": ""}, {'name':'Sydney', "sel": ""}, {'name':'Beijing', "sel": ""}]
        for item in cities:
